/* Park 2.0 compatibility loader + Park 3.0 direct Lab mount
...
(function(){
  ...
  function mountPark3(){
    ...
    section.innerHTML='<div style="display:flex;align-items:center;gap:10px;padding:12px 13px;background:linear-gradient(135deg,#19113d,#28165c);color:#fff">'
      ...
      +'<span style="flex:0 0 auto;padding:8px 9px;border:1px solid rgba(255,255,255,.18);border-radius:10px;color:#dcd7ef;font:800 9px var(--font-display)">Direct in Lab</span>'
      +'</div>'
