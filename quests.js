...
(function () {
  ...
  const QUESTS = {
    ...
    chess: [
      { lvl: 1,  title: 'Board Ready',          desc: 'Set up the board and explain how every piece moves.',                              xp: 40 },
      { lvl: 3,  title: 'Rules Locked',         desc: 'Play a legal game and explain castling, promotion, en passant and stalemate.',     xp: 80 },
      { lvl: 6,  title: 'First Finishes',       desc: 'Solve 20 mixed mate-in-one positions at 80%+ accuracy.',                          xp: 150 },
      { lvl: 10, title: 'Tactical Eye',         desc: 'Score 70%+ across 30 mixed tactics without hints.',                               xp: 300 },
      { lvl: 18, title: 'Opening Discipline',   desc: 'Develop and secure your king in 8 of 10 reviewed rapid games.',                   xp: 450 },
      { lvl: 30, title: 'Endgame Foundation',   desc: 'Execute K+Q and K+R mates and solve 8 of 10 elementary pawn endings.',             xp: 700 },
      { lvl: 45, title: 'Rated Competitor',     desc: 'Complete 30 rated games in one rapid pool and review every loss.',                 xp: 1100 },
      { lvl: 60, title: 'Club Player',          desc: 'Hold 1200+ in that rapid pool across 20 consecutive games.',                      xp: 1800 },
      { lvl: 75, title: 'Strong Club Player',   desc: 'Hold 1500+ in the same rapid pool across 20 consecutive games.',                  xp: 2800 },
      { lvl: 90, title: 'Expert',               desc: 'Hold 1800+ and annotate 10 serious games before engine use.',                     xp: 4200 },
      { lvl: 100,title: 'Mastery',              desc: 'Reach stable 2000+ online rapid or an official 1800+ over-the-board rating.',      xp: 6500 },
    ],
    journaling: [
