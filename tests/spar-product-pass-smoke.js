...
assert.match(home,/park31\.html\?embed=1&amp;mode=missions&amp;privacy=all&amp;surface=home/,'Personal Home embeds public plus PIN-backed private Daily Missions 2.0');
...
assert.match(parkPage,/park31\.js\?v=1\.16/,'Park page loads the current interaction runtime');
