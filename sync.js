// =============================================================
// Shared cloud-sync helper — Gamenfy v11.1
...
//
// Also contains a tiny iOS shell hardening rule for the injected bottom tab bar.
// =============================================================
(function () {
  'use strict';
  ...
  // iOS/PWA shell guard. The bar is injected later by topbar.js, so the rule
  // deliberately uses !important and applies whenever that element appears.
  (function installShellGuard(){
    if (document.getElementById('gamenfy-shell-guard')) return;
    const style = document.createElement('style');
    style.id = 'gamenfy-shell-guard';
    style.textContent = `
      .bottombar{
      ...
      body.has-bottombar{padding-bottom:calc(78px + env(safe-area-inset-bottom))!important;}
    `;
