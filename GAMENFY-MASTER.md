...
1. [x] **Jarvis daily check-in + streak** — shipped in v7.1. Remaining: Joey sets up the iOS Shortcut notification (5 min, instructions given in chat).
