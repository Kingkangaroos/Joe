...
8. 🚧 **Quest hoe-behaal-roadmaps** — ALLE 45 actieve skills hebben nu een volledige tiered ladder (meaning/why/doThis/examples/claim per tier), incl. Path to Superiority met concrete studie-acties per fase (v10.17→v10.26, compleet). **Nog open:** Joey's specifieke wens voor echte oefen-sommen/mini-examens per level (bijv. rekenen met concrete som-checkpoints i.p.v. alleen "doThis"-beschrijvingen) — dat is een preciezere laag bovenop wat er nu staat, nog niet gebouwd. Bevestigen of de huidige diepte voldoende is of dat dit er nog bovenop moet.
